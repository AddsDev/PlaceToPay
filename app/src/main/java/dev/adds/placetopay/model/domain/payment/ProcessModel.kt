...
data class ProcessModel(
    @SerializedName("payer") var payerModel: PayerModel,
    @SerializedName("payment") var paymentModel: PaymentModel,
    @SerializedName("instrument") var instrumentModel: InstrumentModel,
    @SerializedName("ipAddress") var ipAddress: String = "127.0.0.1",
